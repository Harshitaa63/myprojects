...
Original file is located at
    https://colab.research.google.com/drive/1QX8lqAPx32bsOicTaLIy4unsEFeTgn_h
"""
    ...
    def run(self, context):
        ...
        try:
            ...
            if isinstance(response, list) and len(response) > 0:
                ...
                answer = f"Could not generate a response based on the plan. Unexpected LLM response format: {type(response).__name__} - {response}"
